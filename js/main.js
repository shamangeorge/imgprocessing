...
Filter.prototype.use = function() {
    ...
    // video.src = 'https://s3.amazonaws.com/pyth.js/video/elephants_dream.mp4';
    // video.autoplay = true;
    // video.loop = true;
    var width = 512;
    var height = 256;
    ...
    $('#video').css({ width: width, height: height, position:'absolute', marginTop:'0px' });

    anim();
    function anim(){
        texture.loadContentsOf(video);
        drawFunction();
        ANIM_ID = requestAnimationFrame(anim);
    }
